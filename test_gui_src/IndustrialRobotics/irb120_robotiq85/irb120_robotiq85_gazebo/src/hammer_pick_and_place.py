...
class Pick_Place:
    def __init__ (self):
        ...
        print(self.object_name,self.pose_object.position)
        ...
        # curr_pose = self.pose_object
        # x = curr_pose.position.x
        # y = curr_pose.position.y
        # z = curr_pose.position.z

        # self.move_pose_arm(0.0, numpy.deg2rad(90.0), numpy.deg2rad(90.0), x, y, z)
        # self.move_joint_hand(0.5)
    ...
    def add_object(self, name):
        ...
        pack_path = rospack.get_path('irb120_robotiq85_gazebo')
        filename = os.path.join(pack_path,"meshes","hammer.dae")
        self.scene.add_mesh(name, p, filename)
        print("add mesh")
        dz = 0.14
    ...
    def generate_grasps(self, name, pose):
        ...
        q = quaternion_from_euler(0.0, numpy.deg2rad(90.0), numpy.deg2rad(90.0))
